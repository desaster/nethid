...
KEYBOARD_MODIFIER_LEFTSHIFT  = 1
KEYBOARD_MODIFIER_LEFTALT    = 2
KEYBOARD_MODIFIER_LEFTGUI    = 3
KEYBOARD_MODIFIER_RIGHTCTRL  = 4
KEYBOARD_MODIFIER_RIGHTSHIFT = 5
KEYBOARD_MODIFIER_RIGHTALT   = 6
KEYBOARD_MODIFIER_RIGHTGUI   = 7

ascii_to_hid_key_map = [
    (0, HID_KEY_SPACE),
    ...
    (KEYBOARD_MODIFIER_LEFTSHIFT, HID_KEY_D),
    (KEYBOARD_MODIFIER_LEFTSHIFT, HID_KEY_E),
    (KEYBOARD_MODIFIER_LEFTSHIFT, HID_KEY_F),
    (KEYBOARD_MODIFIER_LEFTSHIFT, HID_KEY_G),
    (KEYBOARD_MODIFIER_LEFTSHIFT, HID_KEY_H),
    (KEYBOARD_MODIFIER_LEFTSHIFT, HID_KEY_I),
    (KEYBOARD_MODIFIER_LEFTSHIFT, HID_KEY_J),
    (KEYBOARD_MODIFIER_LEFTSHIFT, HID_KEY_K),
    (KEYBOARD_MODIFIER_LEFTSHIFT, HID_KEY_L),
    (KEYBOARD_MODIFIER_LEFTSHIFT, HID_KEY_M),
    (KEYBOARD_MODIFIER_LEFTSHIFT, HID_KEY_N),
    (KEYBOARD_MODIFIER_LEFTSHIFT, HID_KEY_O),
    (KEYBOARD_MODIFIER_LEFTSHIFT, HID_KEY_P),
    (KEYBOARD_MODIFIER_LEFTSHIFT, HID_KEY_Q),
    (KEYBOARD_MODIFIER_LEFTSHIFT, HID_KEY_R),
    (KEYBOARD_MODIFIER_LEFTSHIFT, HID_KEY_S),
    (KEYBOARD_MODIFIER_LEFTSHIFT, HID_KEY_T),
    (KEYBOARD_MODIFIER_LEFTSHIFT, HID_KEY_U),
    (KEYBOARD_MODIFIER_LEFTSHIFT, HID_KEY_V),
